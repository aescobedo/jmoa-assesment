...
using Exigo.WebService;
    ...
    public class ShoppingCartPropertyBag
    {
        /// <summary>
        ...
        public ShoppingCartPropertyBag(string CookieName)
        {
        ...
        public void Empty()
        {
            // Erase the data in the existing property bag on the server
            ExigoApiContext.CreateWebServiceContext().SetSession(new SetSessionRequest
            {
                SessionID = SessionID,
        ...
        private ShoppingCartPropertyBag CreateNewShoppingCartPropertyBag(string description, string sessionID)
        {
            // Create a string that is the serialized XML of a new ShoppingCart.
            ShoppingCartPropertyBag newPropertyBag = new ShoppingCartPropertyBag();
        ...
        public void LoadPropertyBag(string CookieName)
        {
            ...
            ShoppingCartPropertyBag propertyBag = null;
            ...
            else
            {
                ...
                else
                {
                    ...
                    propertyBag = Deserialize<ShoppingCartPropertyBag>(returnedData);
        ...
        /// </summary>
        /// <param name="propertyBag">The ShoppingCartPropertyBag object that contains the variables you want populated.</param>
        private void PopulateInitialPropertyBagValues(ShoppingCartPropertyBag propertyBag)
        {
