...
public static class GlobalSettings
{
    ...
    {
        public static string ReplicatedSite                     = "http://www.myexigo.com/office/{0}";
        public static string Signup                             = "http://www.myexigo.com/public/{0}/signup.aspx";
        public static string EmailVerification                  = "http://sample.exigo.com/backoffice/VerifyOptIn.aspx";
    ...
    {
        public static string Name                               = "Exigo";
